...
public:
    ...
    void handleErrorInLexical(int lineno);
    void handleErrorInSyntax(int lineno);
    void handleErrorBreak(int lineno);
    void handleErrorInContinue(int lineno);
    void handleErrorInMissingMain(int lineno);
    void handleErrorByteIsTooBig(int lineno, string s);
    void handleErrorPrototypeMismatch(int lineno, const string &id, std::vector<string> &argTypes);
};
