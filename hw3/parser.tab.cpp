...
static const yytype_uint8 yyrline[] =
{
     ...
     101,   103,   105,   107,   109,   111,   114,   116,   118,   121,
     123,   125,   127,   130,   132,   134,   137,   139,   141,   143,
     145,   147,   149,   151,   153,   155,   157,   160,   162,   165,
     167,   169,   171,   173,   176,   178,   180,   182,   184
};
#endif
...
{
  "$end", "error", "$undefined", "TRUE", "FALSE", "RETURN", "ID", "NUM",
  "VOID", "INT", "IF", "SC", "BOOL", "COMMA", "WHILE", "BREAK", "STRING",
  "BYTE", "B", "CONTINUE", "AUTO", "COLON", "ASSIGN", "OR", "AND",
  "EQUAL_UNEQUAL", "NOT_EQUALITY", "ADD", "SUB", "MUL", "DIV", "NOT",
  "LBRACE", "RBRACE", "LPAREN", "RPAREN", "ELSE", "$accept", "Prog",
  "Functions", "FunctionDeclaration", "FunctionHead", "ReturnType",
  "Formals", "FormalsList", "FormalDeclaration", "States", "State", "Call",
  "ExpressionList", "Type", "Pre_Auto", "Expression", "PushStatementScope",
  "PushWhileScope", "PopScope", "CheckBool", YY_NULLPTR
};
#endif
...
{
     164,   -94,   -94,   -94,   -94,     4,   -94,   164,     1,    29,
     -94,   -94,   -94,   150,     5,    59,   -15,    21,    26,    57,
      60,   100,   -94,    61,    75,    64,    53,    -3,   -94,   -94,
      58,    69,   -94,   -94,    70,    25,   -94,    97,    70,     9,
      70,    70,   -94,   -94,   -94,   -94,   -94,     0,    85,   150,
      62,   -94,    86,    92,   -94,   -94,    65,   196,   -94,    70,
      70,    70,    70,    70,    70,    70,    70,   160,   -94,    68,
     123,   177,   177,   -94,   -94,    70,    89,   125,   -94,    -3,
     -94,    70,   -94,   208,   214,   219,   224,    50,    24,    77,
     -94,   -94,   -94,    70,    78,    81,   168,    70,   -94,   -94,
     -94,   -94,   -94,   -94,   -94,   188,   -94,   150,   150,   -94,
     -94,   -94,    82,   -94,   -94,   150,   -94,   -94
};
...
{
       3,     7,    35,    33,    34,     0,     2,     3,     0,     0,
       8,     1,     4,    36,     0,     0,     0,     0,     0,     0,
       0,    36,    14,     0,     0,     0,     0,     9,    48,    47,
      42,    44,    22,    46,     0,     0,    43,     0,     0,     0,
       0,     0,    27,    26,    57,    15,    21,     0,     0,    36,
       0,    10,    11,     0,    45,    49,     0,     0,    23,     0,
       0,     0,     0,     0,     0,     0,     0,     0,    30,     0,
      31,    58,    58,     5,    17,     0,     0,    36,     6,     0,
      13,     0,    37,    50,    51,    53,    52,    41,    40,    39,
      38,    20,    29,     0,     0,     0,     0,     0,    57,    12,
      54,    32,    55,    56,    18,     0,    16,    36,    36,    19,
      57,    57,    24,    28,    55,    36,    57,    25
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -94,   -94,   121,   -94,   -94,   -94,   -94,    66,   -94,    80,
     -19,   -13,    45,     3,   -94,   -14,   -45,   -94,   -93,    71
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     5,     6,     7,     8,     9,    50,    51,    52,    21,
      22,    36,    69,    24,    25,    70,    26,   108,    73,    94
};
...
{
      23,    37,    45,    10,    11,   106,     2,    38,    23,     3,
      10,    74,    28,    29,     4,    30,    31,   112,   113,    39,
      55,    57,    75,   117,    67,    33,    71,    72,    28,    29,
      53,    30,    31,    13,     2,    14,    23,     3,    56,    27,
      34,    33,     4,    35,    68,    83,    84,    85,    86,    87,
      88,    89,    90,    65,    66,    40,    34,   107,    45,    35,
      41,    96,    28,    29,    23,    30,    31,   100,    42,   115,
      32,    43,    46,    28,    29,    33,    30,    31,    64,    65,
      66,    47,    53,   105,    48,    49,    33,    54,   110,   111,
      34,    76,    39,    35,    23,    23,   116,    78,    80,    79,
      81,    34,    23,    92,    35,    15,    16,    66,    58,     2,
      17,    97,     3,   102,    18,    19,   103,     4,   114,    20,
      59,    60,    61,    62,    63,    64,    65,    66,    12,    77,
      15,    16,   -55,    44,     2,    17,    93,     3,   101,    18,
      19,     0,     4,    95,    20,    99,    59,    60,    61,    62,
      63,    64,    65,    66,     0,    15,    16,   -55,    98,     2,
      17,     0,     3,     0,    18,    19,     0,     4,     0,    20,
       0,    91,     1,     2,     0,     0,     3,     0,     0,   104,
       0,     4,   -55,    59,    60,    61,    62,    63,    64,    65,
      66,    59,    60,    61,    62,    63,    64,    65,    66,   109,
      59,    60,    61,    62,    63,    64,    65,    66,     0,     0,
       0,    59,    60,    61,    62,    63,    64,    65,    66,    59,
      60,    61,    62,    63,    64,    65,    66,     0,     0,     0,
       0,    82,    60,    61,    62,    63,    64,    65,    66,    61,
...
{
      13,    15,    21,     0,     0,    98,     9,    22,    21,    12,
       7,    11,     3,     4,    17,     6,     7,   110,   111,    34,
      34,    35,    22,   116,    38,    16,    40,    41,     3,     4,
      27,     6,     7,    32,     9,     6,    49,    12,    35,    34,
      31,    16,    17,    34,    35,    59,    60,    61,    62,    63,
      64,    65,    66,    29,    30,    34,    31,   102,    77,    34,
      34,    75,     3,     4,    77,     6,     7,    81,    11,   114,
      11,    11,    11,     3,     4,    16,     6,     7,    28,    29,
      30,     6,    79,    97,    20,    32,    16,    18,   107,   108,
      31,     6,    34,    34,   107,   108,   115,    35,     6,    13,
      35,    31,   115,    35,    34,     5,     6,    30,    11,     9,
      10,    22,    12,    35,    14,    15,    35,    17,    36,    19,
      23,    24,    25,    26,    27,    28,    29,    30,     7,    49,
       5,     6,    32,    33,     9,    10,    13,    12,    93,    14,
      15,    -1,    17,    72,    19,    79,    23,    24,    25,    26,
      27,    28,    29,    30,    -1,     5,     6,    32,    33,     9,
      10,    -1,    12,    -1,    14,    15,    -1,    17,    -1,    19,
      -1,    11,     8,     9,    -1,    -1,    12,    -1,    -1,    11,
      -1,    17,    32,    23,    24,    25,    26,    27,    28,    29,
      30,    23,    24,    25,    26,    27,    28,    29,    30,    11,
      23,    24,    25,    26,    27,    28,    29,    30,    -1,    -1,
      -1,    23,    24,    25,    26,    27,    28,    29,    30,    23,
      24,    25,    26,    27,    28,    29,    30,    -1,    -1,    -1,
      -1,    35,    24,    25,    26,    27,    28,    29,    30,    25,
...
{
       0,     8,     9,    12,    17,    38,    39,    40,    41,    42,
      50,     0,    39,    32,     6,     5,     6,    10,    14,    15,
      19,    46,    47,    48,    50,    51,    53,    34,     3,     4,
       6,     7,    11,    16,    31,    34,    48,    52,    22,    34,
      34,    34,    11,    11,    33,    47,    11,     6,    20,    32,
      43,    44,    45,    50,    18,    52,    50,    52,    11,    23,
      24,    25,    26,    27,    28,    29,    30,    52,    35,    49,
      52,    52,    52,    55,    11,    22,     6,    46,    35,    13,
       6,    35,    35,    52,    52,    52,    52,    52,    52,    52,
      52,    11,    35,    13,    56,    56,    52,    22,    33,    44,
      52,    49,    35,    35,    11,    52,    55,    53,    54,    11,
      47,    47,    55,    55,    36,    53,    47,    55
};
...
#line 74 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().parseFunctionDef( (yyvsp[-4]), (yyvsp[-3]), (yyvsp[-1]), yylineno);}
...
#line 78 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pReturnType( (yyvsp[0]), yylineno);}
...
#line 82 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pFormals( (yyvsp[0]), yylineno);}
#line 1393 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 11:
#line 84 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pFormList( (yyvsp[0]), yylineno);}
#line 1399 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 12:
#line 86 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pFormList( (yyvsp[-2]), (yyvsp[0]), yylineno);}
#line 1405 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 13:
#line 88 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().ParseFormalDecl((yyvsp[-1]), (yyvsp[0]), yylineno);}
...
#line 96 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().parseStateType( (yyvsp[-2]), (yyvsp[-1]), yylineno);}
#line 1435 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 18:
#line 98 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().parseStateTypeAssignment( (yyvsp[-4]), (yyvsp[-3]), (yyvsp[-1]), yylineno);}
#line 1441 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 19:
#line 100 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().parseStateTypeAssignment( (yyvsp[-5]), (yyvsp[-3]), (yyvsp[-1]), yylineno);}
#line 1447 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 20:
#line 102 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().parseStateAssignment( (yyvsp[-3]), (yyvsp[-1]), yylineno);}
...
#line 108 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().parseStateRetExpression( (yyvsp[-1]), yylineno);}
...
#line 122 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pCall( (yyvsp[-3]), (yyvsp[-1]), yylineno);}
#line 1507 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 30:
#line 124 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pCall( (yyvsp[-2]), yylineno);}
#line 1513 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 31:
#line 126 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pExpressionList( (yyvsp[0]), yylineno);}
#line 1519 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 32:
#line 128 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pExpressionList( (yyvsp[-2]), (yyvsp[0]), yylineno);}
...
#line 138 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pAuto(yylineno);}
#line 1549 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 37:
#line 140 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pParen( (yyvsp[-1]), yylineno);}
#line 1555 "parser.tab.cpp" /* yacc.c:1646  */
    break;

  case 38:
#line 142 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pBinaryOp( (yyvsp[-2]), (yyvsp[0]), yylineno);}
...
#line 177 "parser.ypp" /* yacc.c:1646  */
    {(yyval) = Utils::instance().pCast( (yyvsp[-2]), (yyvsp[0]), yylineno);}
...
#line 185 "parser.ypp" /* yacc.c:1646  */
    {Utils::instance().pCheckBool( (yyvsp[0]), yylineno);}
...
#line 186 "parser.ypp" /* yacc.c:1906  */
